...
/**
 * Calendar 클래스 : 추상클래스(객체화 불가) => new Calendar으로 객체화 불가.
...
public class CalendarEx1 {
	public static void main(String[] args) {
		...
		System.out.println("연도기준 몇째주:"+now.get(Calendar.WEEK_OF_YEAR));
		...
		System.out.println("연 기준일자:"+now.get(Calendar.DAY_OF_YEAR));
