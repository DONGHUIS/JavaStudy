package chap8;
/*
 * 람다식(함수객체) 예제 : jdk8이후부터 사용가능함.
 * 					 람다식으로 사용할 수 있는 인터페이스는 FunctionalInterface여야함.
 * 
 ...
 */
@FunctionalInterface  //어노테이션 검증.(람다방식을 사용하기 위해서 꼭 사용해야함.)
interface LambdaInterface1{ //람다식에서 사용하기 위해서는 FunctionalInterface여야함.
	void method();
}
