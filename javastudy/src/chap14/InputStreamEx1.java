...
/*
 * 입출력스트림  데이터 이동통로 ,단방향 , 버퍼를 가진다.
 * 	입력스트림 
 * 	   바이트 : 1byte 단위 읽기. - 동영상,이미지등의 데이터 처리 => InputStream
 * 			  하위클래스 : FileInputStream , ObjectInputStream ...
 * 	   문자 : 2byte 단위 읽기. - 텍스트 데이터 처리			=> Reader
 * 			  하위클래스 : FileReader , StringReader...
 *  출력스트림
 *     바이트 : 1byte 단위 읽기. - 동영상,이미지등의 데이터 처리 => OutputStream
 ...
 *  표준 입력 객체 :   InputStream System.in : 키보드 입력
 *  표준 출력 객체 :   PrintStream System.out : 콘솔 출력
 *  표쥰 오류 객체 :   PrintStream System.err : 콘솔 출력
 */
