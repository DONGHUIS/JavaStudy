 ...
 * 생성자는 오버로딩이 가능함.
 * 
 * 기본생성자 : 클래스 내부에 생성자를 구현하지 않으면 컴파일러가 추가 해주는 생성자
 * 
 * 생성자 구현방법
 * 1, 생성자의 이름은 클래스명과 같다.
 * 2, 리턴타입이 없다.void도 기술하지않는다.
 */
class Number1{ //생성자 구현 안됨. => 기본생성자 제공
	int num;
//	public Number1() {}//->기본생성자의 형태
}

class Number2{ //생성자를 구현하였기 때문에 기본생성자 제공 안됨.
	int num;
	Number2(int n){//생성자
		num = n;
	}
...
public class ConstructorEx1 {
	public static void main(String[] args) {
		 ...
		 * 	1,힙 영역에 메모리 할당 
		 * 	2,기본값으로 초기화
		 * 	3,생성자를 호출 => 클래스 구현된 생성자 형태로 호출해야함. */
